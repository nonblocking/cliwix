...
@XmlRootElement(name = "LocalizedTextContent")
@XmlAccessorType(XmlAccessType.FIELD)
public class LocalizedTextContent extends ComparableAndIdentifiableObject implements Serializable {
    ...
    public LocalizedTextContent() {
    }

    public LocalizedTextContent(String locale, String text) {
        this.locale = locale;
        this.text = text;
    }
